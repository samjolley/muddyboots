			...
			if($snippet_on) {
				...
				if($custom_product!='') {
					...
					if($use_cat_as_prod) {
						...
						if( isset($query->query_vars['tax_query']) && $query->query_vars['tax_query'][0]['taxonomy'] == 'ttshowcase_groups' ) {

							$term = get_term_by('slug', $query->query_vars['tax_query'][0]['terms'], 'ttshowcase_groups');
